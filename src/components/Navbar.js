...
>
  <span className="relative flex h-3 w-3">
    ...
    <span className="absolute left-16 inline-flex rounded-full h-3 w-3 bg-sky-500"></span>
    Resume
  </span>
</Link>
      </nav>
      ...
      >
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://github.com/Hussein039"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
        ...
        <motion.a
          target={"_blank"}
          className="w-6 mx-3"
          href="https://www.linkedin.com/in/hussein-saadol/"
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/public/Hussein Resumedocx.docx" title="Resume" />
      </nav>
      <nav
