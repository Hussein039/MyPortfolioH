    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="aws cloud practitioner Certification"
            time="March 2023 - June 2023"
            place="Youth Employment Services(YES)"
            info="The course included the knowledge about the cloud."
          />

          <Details
            type="Software Engineering"
            time="September 2018- August 2022"
            place="Centennial College"
            info="Completed a software Engineering diploma."
          />
        </ul>
      </div>
    </div>
